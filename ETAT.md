...
- 15h41 Paris : source Zebra_v1.mq5 avec frein (sha256 2C39B337…) installée sur Ultima et Vantage Londres (ancien source Ultima gardé en .avant_frein_20260925). Attend compilation par Denis dans MetaEditor (Ultima puis Vantage). 11h02 : Ultima 50 ordres, tous jeux présents ; plus de connexion depuis 62.216.81.78.
- 15h43 (Ultima) et 15h46 (Vantage) Paris : Denis a compilé Zebra avec frein dans MetaEditor ; les 6 graphiques Zebra rechargés seuls, réglages identiques (espion 15h47). Frein mesuré sur Ultima : refus 85-93/min avant → 5-6/min après. Le stop suiveur reste refusé à 1 pip : À FAIRE = test distance (v1 vs StopsLevelMin 20/30 vs v1b vs sans suivi) sur 2021-24 + 2025, après verdict ticks. Retour arrière : fichiers *.avant_frein_20260925.
- 16h52 Paris : test distance stop suiveur Zebra en file sur le PC (outils/suite_zebra_suivi.sh, log suite_zebra_suivi.log) : attend fin de chaine_standards_vrais, importe EURUSD_VRAI et GBPUSD_VRAI, puis 16 .ini zt_{eur,gbp}_{reel,s20,s30,sans}_{2124,2526} par lance_chaine.ps1. v1b écarté (le testeur n'applique pas le minimum caché). Dans le testeur « reel » = suivi qui marche ; le réel observé ≈ « sans ». Début estimé ~21h35 Paris. Anomalie signalée : chaine_standards_vrais.log muet depuis 15h13 → repasser mesure.py sur vt03/vt04.
- 26/09 18h09 Paris : Denis « retire zebra », choix « tout Zebra » (6 graphiques H1 : XAU, EUR, GBP sur Ultima et Vantage Londres). Accord écrit 18h10 : supprimer les 8 ordres en attente Zebra après retrait ; la position Ultima EURUSD #…0612 (achat 0,01) reste jusqu'à SL/TP. OnDeinit de Zebra ne supprime aucun ordre. Attend les 6 gestes de Denis.
- Tests zt_* (ticks réels, 0,01, 10 000 $, passés le 26/09 par chaine_toutes_jambes_vrais) — net/creux fonds/PF : EUR 21-24 reel +17/4,25/1,39, s20 +22/5,09, s30 +33/6,57, sans +64/51,8/1,11 ; EUR 25-26 reel −5,7, s20 −5,8, s30 −12,3, sans +9,0/27,9 ; GBP 21-24 reel +9,9/18,3, s30 +10,4/12,4, sans −38/97,5 ; GBP 25-26 reel −13,0, s20 −6,5, s30 +0,6, sans −32/69,7. Réel ≈ « sans ». Zebra XAU non testé ici.
- 26/09 18h14 Paris : Zebra retiré des 6 graphiques (journal + espion 18h18). Suppression des 8 ordres Zebra refusée (samedi, 10018 Market closed). EN COURS SEUL : outils\suppr_zebra_ouverture.sh sur le PC (log suppr_zebra_ouverture.log), part dim 27/09 22h55 Paris, réessaie chaque minute, butée lun 10h ; vise seulement les 8 tickets (Ultima …0613 …0750 …0761 …1470 ; Vantage …2541 …2134 …1308 …3766), aucune position. Exige PC allumé. Position Ultima EURUSD #…0612 laissée à SL/TP.
- 26/09 18h26 Paris : M5_H (magic 87008, retiré par le verdict du 21/09 mais encore chargé) sorti de SetsUltima et SetsVantage → _sauvegardes_sets\M5_H_Sets{Ultima,Vantage}_retire_20260926.set (sha256 vérifiés). Aucun ordre ni position 87008. Attend F7 de Denis sur UBS XAUUSD M15 des deux comptes.
- 26/09 18h13 Paris : Ultima Londres redémarré par sa MISE À JOUR AUTOMATIQUE (LiveUpdate, build 6193→6230) : tous les experts déchargés puis rechargés en 10 s ; 6 positions / 45 ordres intacts. Vantage reste en 6200. Risque : redémarrage automatique en semaine (UBS peut annuler/reposer). Piste : désactiver LiveUpdate du terminal réel, mettre à jour le week-end.
- 26/09 18h35 Paris : blocage des mises à jour MT5 sur Londres (accord Denis 18h29). C:\GT\maj_bloquer.ps1 / maj_autoriser.ps1 (Deny écriture pour fxut9888731\trader sur liveupdate d'Ultima et Vantage), log C:\GT\maj.log, ACL d'avant C:\GT\acl_liveupdate_avant_20260926.txt. Tâches SYSTEM : autoriser sam 08:00 UTC, bloquer dim 16:00 UTC (1er : 27/09). Testé sur témoin (fichier refusé ; sous-dossier encore possible). Vantage a une mise à jour 6230 déjà téléchargée (25/09) : proposé que le blocage l'efface (attend accord). Retour arrière : maj_autoriser.ps1 + supprimer les 2 tâches. Axi et PU Prime tournent aussi sur Londres depuis 26/09 18h16.
- 26/09 18h31 (Ultima) / 18h32 (Vantage) Paris : UBS XAUUSD rechargé, 13 sets sans M5_H, M5_C présent ; ordres/positions identiques (Ultima 6/45, Vantage 5/37). M5_H RETIRÉ. Accord Denis 18h33 : le blocage du dimanche efface aussi les mises à jour en attente (liveupdate).
